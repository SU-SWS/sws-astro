  ...
  return (
    <section className="border-t border-black-60/55 pt-38 first:border-t-0 first:pt-0">
      <div className="grid gap-61 lg:grid-cols-[minmax(0,1fr)_200px]">
        <div>
          <h3 className="font-serif text-29 leading-snug text-dark-primary md:text-33 lg:text-36">{title}</h3>
          <p className="max-w-540 pt-38 text-19 leading-normal text-dark-primary md:text-21">{body}</p>
        </div>
        <ul className="pt-38 text-dark-secondary-muted">

// import mastheadStanfordWordmark from '../images/masthead-stanford-wordmark.svg';
// import stanfordRedWordmark from '../images/stanford-red-wordmark.svg';
  ...
  return (
    <div className={`relative flex h-[48px] w-[303.5px] flex-[0_0_auto] items-start ${className}`}>
      <div className="mt-[11px] w-[155px] shrink-0">
        {/* <img
          src={isDark ? stanfordRedWordmark.src : mastheadStanfordWordmark.src}
          alt=""
          width={155}
          height={32}

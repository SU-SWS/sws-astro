export const root = 'w-full basefont-20 rs-py-1 text-dark-primary bg-cardinal-red';
export const outerWrapper = 'flex flex-col lg:flex-row';
...
export const menusWrapper = 'flex justify-center sm:flex-col sm:items-center lg:items-start mb-10';
...
export const link = 'text-dark-primary no-underline hocus:underline hocus:text-dark-primary';
